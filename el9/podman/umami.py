#!/usr/bin/env python3
# Umami (postgres) — rootless Podman, single container
...
API_BASE='/api/v1'; IMG='docker.io/umamisoftware/umami:postgres-latest'
def sh(c,q=False): 
...
# REQUIRED
DATABASE_URL="postgres://user:pass@host:5432/umami?sslmode=require"
...
""")
readme=f"Umami on port {port}. Set DATABASE_URL + APP_SECRET in {appdir}/.env. First boot runs migrations."
...
print("umami installed",name,port,osuser)
