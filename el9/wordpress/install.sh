...
then
    ...
    /usr/bin/php85 -d "memory_limit=256m" $HOME/bin/wp cli update --yes
    /usr/bin/php85 -d "memory_limit=256m" $HOME/bin/wp core download --path=/home/$USER/apps/$APPNAME
    /usr/bin/php85 -d "memory_limit=256m" $HOME/bin/wp core config --dbhost=localhost --dbname=$DBNAME --dbuser=$DBUSER --dbpass=$DBPWD --path=/home/$USER/apps/$APPNAME
    ...
    echo $firstLine
    /usr/bin/php85 -d "memory_limit=256m" $HOME/bin/wp option set default_comment_status closed --path=/home/$USER/apps/$APPNAME
